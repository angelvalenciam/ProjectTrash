    ...
    <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
      <div class="flex-row text-center mx-auto">
        ...
        <div class="mx-auto">
          ...
          <h3>Todos juntos para un mundo mejor</h3>
        </div>
      </div>
    </div>
    <!-- /Left Text -->
      ...
      <div class="w-px-400 mx-auto">
        ...
        <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('email') is-invalid @enderror" id="login-email" name="email" placeholder="angel@example.com" autofocus value="{{ old('email') }}">
            @error('email')
          ...
          <div class="mb-3 form-password-toggle">
            <div class="d-flex justify-content-between">
              <label class="form-label" for="login-password">Clave</label>
        ...
        <p class="text-center">
          <span>Soy nuevo en la plataforma?</span>
